...
val cocktailDBApiKey: String = gradleLocalProperties(rootDir, providers).getProperty("COCKTAIL_DB_API_KEY")
...
android {
    ...
    defaultConfig {
        applicationId = "com.wreckingballsoftware.fiveoclocksomewhere"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
